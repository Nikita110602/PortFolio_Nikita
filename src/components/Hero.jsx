    ...
    >
      <div className="flex flex-wrap items-center">
        <div className="w-full lg:w-1/2 h-screen lg:h-auto flex flex-col justify-center lg:items-start">
          ...
          >
            Nikita Sharma <span><button className="button-86"><a href="https://drive.google.com/file/d/11vr8goMjfjl8SVl_cFeiQUCUSAv7huZK/view">My Resume</a></button></span>
          </motion.h1>
          <motion.span
          ...
          >
            Hi, I'm Nikita Sharma, a passionate Full Stack Developer with a
